...
let
  scratchpad = import ../../uima/uifw/scratchpad.nix;
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "SUPER CTRL, n,       exec, ${lib.getExe' workNoteScratchpad "open-ws-work-note"}"
        "SUPER SHIFT CTRL, n, exec, ${lib.getExe' workNoteScratchpad "open-work-note"}"
